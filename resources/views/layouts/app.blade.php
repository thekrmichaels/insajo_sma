                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            @forelse (auth()->user()->unreadNotifications as $notification)
                                <span class="d-inline-block text-truncate" style="max-width: 250px;">
                                    ...
                                    <br>
                                    <span class="d-inline-block text-truncate text-sm"
                                        style="max-width: 250px;">{{ $notification->created_at->toDateTimeString() }}</span>
                                </span>
                            @empty
                            ...
                            @if (count(auth()->user()->unreadNotifications) > 0)
                                <a href={{ route('markAsRead') }} class="dropdown-item dropdown-footer">Marcar todas como
                                    leídas</a>
                            @endif
                        </div>
                    </li>
